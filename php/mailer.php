 ...
 * mailer.php
 *
 * This file handles secure mail transport using Swiftmailer
 * and Mailgun with Google reCAPTCHA integration.
 *
...
try {
	//if there's a reCAPTCHA error, kick 'em out early!
	if (!$resp->isSuccess()) {
		throw(new Exception("reCAPTCHA error!"));
	}

	/**
	 * Sanitize the inputs from the form: name, email, subject, and message. Utilize each form input field's NAME attribute here...
	 ...
	 * special version utilizing html_entity_decode() which generates a plain text
	...
	// report a successful send to the front end!
